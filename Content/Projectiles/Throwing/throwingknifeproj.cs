...
namespace zeffmod.Content.Projectiles.Throwing
{
    ...
    public class throwingknifeproj : ModProjectile
    {
        public override string Texture => "zeffmod/Assets/Projectiles/" + this.Name;
